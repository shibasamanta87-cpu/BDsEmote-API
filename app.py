...
async def MaiiiinE():
    ...
    # BOT LOGIN UID
    BOT_UID = int('14147699252')  # <-- FIXED BOT UID

    Uid, Pw = '4347038297', 'PRO_PROSTAR_UXML6'
    ...
    os.system('clear')
    print(render('PRO', colors=['white', 'green'], align='center'))
